#!/usr/bin/env python3
"""Generate Firefox Add-ons promotional images for Google AI Overview Scraper."""
...
def create_screenshot_how_it_works():
    ...
    boxes = [
        ...
        {"label": "Firefox Add-on", "sub": "Background Tab", "color": (234, 67, 53), "x": 860},
    ]
    ...
    # Vertical arrow from Firefox Add-on down to Google
    ...
    features = [
        {
            ...
            "detail": "Uses your existing Firefox browser session",
            "color": (52, 168, 83),
        },
        {
